...
import { clearCart, removeCartItem, addCartPizzaItem, removeCartPizzaItem } from '../redux/actions/cart'
...
function Cart() {
	...
	const onPlusCartPizzaItem = (id) => {
		dispatch(addCartPizzaItem(id))
	}

	const onMinusCartPizzaItem = (id) => {
		dispatch(removeCartPizzaItem(id))
	}
				...
				<div className="cart">
					...
					<div className="content__items">
						{
							addedPizzas.map(el =>
								<CartItem
									...
									onAddCartPizzaItem={onPlusCartPizzaItem}
									onRemoveCartPizzaItem={onMinusCartPizzaItem}
								/>)
						}
					</div>
					<div className="cart__bottom">
						...
						<div className="cart__bottom-buttons">
							...
							<div className="button pay-btn" onClick={onBuyOrder}>
